...
export default function HeroSection() {
    return (
        <section className="w-full max-w-6xl mx-auto px-6 py-24 md:py-32 flex flex-col items-center text-center relative">
            ...
            >
                Bikode is a powerful, open-source wrapper for Notepad that supercharges your daily text editing with modern features, seamless performance, and developer-friendly tools.
            </motion.p>
            ...
            >
                <a href="https://github.com/EugeneBoondock/Biko/releases/latest" className="group relative flex items-center justify-center gap-2 px-8 py-3 bg-primary hover:bg-primary-dark text-white rounded-xl font-medium transition-all hover:scale-105 active:scale-95 shadow-lg shadow-primary/25">
                    <Download size={18} />
                ...
                <a href="https://github.com/EugeneBoondock/Biko" target="_blank" rel="noreferrer" className="group flex items-center justify-center gap-2 px-8 py-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-xl font-medium transition-all hover:scale-105 active:scale-95">
                    <Github size={18} />
